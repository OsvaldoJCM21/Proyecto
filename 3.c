...
void guardarDatos() {
    ...
    for (int i = 0; i < total_activos; i++) {
        fprintf(archivo, "%s %s %s %.2f %d %d\n", inventario[i].nombre, inventario[i].tipo, inventario[i].proyecto, 
                inventario[i].valor_original, inventario[i].vida_util, inventario[i].anio_compra);
    }
...
void cargarDatos() {
    ...
    for (int i = 0; i < total_activos; i++) {
        fscanf(archivo, "%s %s %s %f %d %d", inventario[i].nombre, inventario[i].tipo, inventario[i].proyecto, 
               &inventario[i].valor_original, &inventario[i].vida_util, &inventario[i].anio_compra);
    }
